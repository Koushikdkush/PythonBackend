"""add booleand isDeleted to users

Revision ID: 335c9f86d6df
Revises: 8a10c1858e50
Create Date: 2026-08-20 09:21:56.365268
...
revision: str = '335c9f86d6df'
down_revision: Union[str, Sequence[str], None] = '8a10c1858e50'
...
def upgrade() -> None:
    ...
    op.drop_table('posts')
    op.add_column('users', sa.Column('idDeleted', sa.Boolean(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'idDeleted')
